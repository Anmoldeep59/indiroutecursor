...
import { AnimatedLogisticsHero } from "@/components/brand/AnimatedLogisticsHero";
import { BringingIndiaBanner } from "@/components/brand/BringingIndiaBanner";
import { ExploreServices } from "@/components/brand/ExploreServices";
import { FleetParade } from "@/components/brand/FleetParade";
import { IndiaCraftStrip } from "@/components/brand/IndiaCraftStrip";
import { IndiaMapRoute } from "@/components/brand/IndiaMapRoute";
import { MultimodalScene } from "@/components/brand/MultimodalScene";
  ...
  return (
    <div className="max-w-[100vw] overflow-x-clip bg-[color:var(--ivory)]">
      ...
      <section className="relative overflow-x-clip bg-[color:var(--navy)]">
        ...
        />
        <div className="hero-grid-fade pointer-events-none absolute inset-0 opacity-[0.08]" aria-hidden />
        ...
        <div className="mx-auto max-w-[1140px] px-4 md:px-5">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {hubs.map((h, i) => (
              <div
                key={h.code}
                className="hub-card relative overflow-hidden rounded-xl border border-[color:var(--line)] bg-[color:var(--surface)] p-5 shadow-sm"
      ...
      <section className="py-14">
        <div className="mx-auto max-w-[1140px] space-y-8 px-4 md:px-5">
        ...
        <div className="mx-auto max-w-[1140px] px-4 md:px-5">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {howSteps.map((s) => (
              <div
                key={s.n}
                className="step-rise rounded-xl border border-[color:var(--line)] bg-[color:var(--surface)] px-5 py-6 text-center shadow-sm"
              >
      ...
      <section className="border-y border-[color:var(--line)] bg-[color:var(--surface)] py-12">
        <div className="mx-auto flex max-w-[1140px] flex-col items-start justify-between gap-6 px-4 md:flex-row md:items-center md:px-5">
          <div>
            <h2 className="ir-headline text-2xl font-bold text-[color:var(--ink)] md:text-3xl">
